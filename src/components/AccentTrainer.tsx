...
import { generateSpeech, decodeAudio, decodeAudioData } from '../services/openRouterService';
      ...
      <div className="grid grid-cols-2 gap-4 mb-8">
        {['Kore', 'Puck', 'Fenrir', 'Charon'].map((v) => (
          <button
            key={v}
            onClick={() => setVoice(v)}
            className={`p-4 rounded-xl border-2 text-center font-bold transition-all ${voice === v
